...
\institute{
    Pocket Network Inc.; \url{www.pokt.network}
    \and
    Pocket Scan Technologies LLC; \url{www.poktscan.com}
}
...
% TODO(olshansky): Olshansky rushed through this just to get something on paper
% - Add reference to this in the third bullet point: https://github.com/pokt-network/pocket-core/blob/staging/doc/specs/reward_protocol.md
% - Add a citation for IAVL
% - Improve this in general
